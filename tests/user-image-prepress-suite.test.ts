...
describe('User-Facing Commercial Image Pre-Press Suite', () => {
  ...
  it('02. AcrylicCharmBuilder: should generate 2mm dieline and white underbase', () => {
  ...
  it('03. StickerKisscutBuilder: should generate cute white border and cutline', () => {
    const img = createMockImg(20, 20, 200, 50, 50);
  ...
  it('04. TshirtColorKnockout: should knockout matching garment color', () => {
  ...
  it('05. RealPaperSimulator: should simulate kraft and woodfree paper absorbency', () => {
