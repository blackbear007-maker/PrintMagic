  ...
  <header class="pm-header">
    <div class="pm-header-inner">
      ...
      <div class="pm-header-actions">
        ...
        <!-- Text Inspection Quick Action (Advanced Only) -->
        <button id="btnOpenTextInspectHeader" class="pm-tool-btn pm-advanced-only" style="background: rgba(52, 199, 89, 0.08); color: #248a3d; border-color: rgba(52, 199, 89, 0.25); font-weight: 600;" title="自動檢測圖片中的文字拼寫與 AI 繪圖偽字亂碼">
          <span>📝</span> 檢查文字
        </button>
        ...
        <button id="btnOpenCalibration" class="pm-tool-btn pm-advanced-only" title="拿一張信用卡貼在螢幕上校準 1:1 真實物理尺寸 PPI">
          <span>📏</span> 螢幕校準
        </button>
    ...
    <div class="pm-preset-bar-inner">
      ...
      <div class="pm-simple-preset-bar" id="simplePresetBar">
        <div class="pm-simple-preset-pill" id="simplePresetActivePill" role="button" tabindex="0" title="點擊切換印刷規格 (A3/明信片/名片/貼紙/社群)">
          <span id="simplePresetIcon">📄</span>
          <span id="simplePresetName" style="font-weight: 700; color: var(--pm-text-primary);">A4 經典海報 (210×297mm)</span>
          <span class="pm-preset-auto-badge" id="simplePresetAutoBadge" style="display: none;">✨ 自動適配</span>
      ...
      <div class="pm-advanced-preset-bar pm-advanced-only" id="advancedPresetBar">
        <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
          ...
          <span id="presetAutoBadge" class="pm-preset-auto-badge" style="display: none;">✨ 智慧適配</span>
      ...
      <div class="pm-card">
        ...
        <div class="pm-view-toolbar">
          ...
          <div class="pm-view-toolbar-secondary pm-advanced-only">
            ...
            <div class="pm-foil-selector">
              ...
              <button class="pm-foil-btn pm-foil-gold-pill" data-foil="gold" title="經典奢華亮金燙金模擬 (移動滑鼠/傾斜手機反光)">✨ 亮金</button>
              <button class="pm-foil-btn pm-foil-rosegold-pill" data-foil="rose-gold" title="名媛奢華玫瑰金模擬">🌸 玫瑰金</button>
              <button class="pm-foil-btn pm-foil-silver-pill" data-foil="silver" title="未來科技亮銀箔模擬">⚡ 亮銀</button>
              <button class="pm-foil-btn pm-foil-uv-pill" data-foil="spot-uv" title="透明水晶立體局部光 (Spot UV)">💎 局部光</button>
              <button class="pm-foil-btn pm-foil-holo-pill" data-foil="holographic" title="雷射七彩全息光譜">🌈 雷射</button>
            </div>
            ...
            <div class="pm-icc-profile-control" title="上傳您印刷廠提供的 CMYK ICC 描述檔（.icc/.icm），軟打樣將改用該描述檔透過自建服務進行真實色彩管理運算（LittleCMS）；未上傳時沿用內建的近似模擬。描述檔會隨圖片一併傳送至本專案自建的處理服務進行運算，不會轉存或用於其他用途；開啟「100% 本機模式」(Privacy Shield) 時，此功能會停用並自動改回近似模擬。">
              <label for="iccProfileInput" class="pm-icc-upload-label pm-tool-btn">
                <span>📁</span> <span id="iccProfileStatus">上傳 ICC 描述檔（選用，真實色彩管理）</span>
              </label>
        ...
        <div class="pm-stage-view pm-paper-glossy" id="stageContainer">
          ...
          <div class="pm-canvas-score-pill" id="canvasScorePill" style="display: none;" title="點擊查看完整印前健檢報告">
            ...
            <span id="canvasScoreVerdict" class="pm-score-verdict">✨ 完美就緒</span>
          </div>
          ...
          <button id="btnPromptAddBack" class="pm-backside-prompt" type="button" style="display: none;" title="點擊載入背面公版或選擇圖片">
            <span>📇 ＋ 加入【背面】視覺 (選用 · 雙圖自動合併為雙面 PDF)</span>
          </button>
        ...
        <div class="pm-export-bar">
          ...
          <div class="pm-export-simple-row" id="simpleExportRow">
            <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; width: 100%;">
              ...
              <button id="btnSimpleExportPng" class="pm-btn pm-btn-secondary pm-btn-md" title="匯出 300 DPI 高畫質 PNG 圖檔（相簿保存 / 傳 LINE / 手機沖洗）">
                <span>📥</span> 下載高清 PNG <span style="font-size: 0.68rem; color: var(--pm-text-muted); font-weight: 500;">(相簿/LINE)</span>
              </button>
          ...
          <div class="pm-macos-dock pm-advanced-only" id="advancedExportRow">
            ...
            <div class="pm-dock-section">
              <span class="pm-dock-section-label">🏭 出圖工藝</span>
