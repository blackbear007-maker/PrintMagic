        ...
        <div class="pm-modal-header" style="border-bottom: none; padding-bottom: 0;">
          <div style="text-align: center; width: 100%;">
            <span style="display: inline-block; padding: 4px 14px; background: rgba(52, 199, 89, 0.12); color: #248a3d; border: 1px solid rgba(52, 199, 89, 0.3); border-radius: 999px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.04em; text-transform: uppercase; margin-bottom: 8px;">
              <img src="icons/shared/sparkle.webp" alt="" class="pm-icon-img" /> Public Beta 測試版
            </span>
          ...
          <button class="pm-modal-close" id="btnClosePricing" style="position: absolute; right: 20px; top: 20px;"><img src="icons/shared/close.webp" alt="" class="pm-icon-img" /></button>
        </div>
        ...
        <div class="pm-modal-body" style="padding: 24px 16px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px;">
            ...
            <div style="background: rgba(60, 30, 140, 0.04); border: 1.5px solid rgba(60, 30, 140, 0.2); border-radius: 16px; padding: 22px 18px; display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                  <img src="icons/shared/sparkle.webp" alt="" class="pm-icon-img" />
                ...
                <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 0.82rem; color: var(--pm-text-secondary);">
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>AI 3mm 出血外擴延伸</strong>：防裁切切頭</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>髮絲級 AI 精準去背</strong>：透明貼紙專用</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>AI 點陣轉真向量 SVG</strong>：三次貝茲曲線擬合</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>K100 純黑文字覆蓋</strong>：文字不糊邊</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>AI 錯字與亂碼檢查</strong>：智能校正</span></li>
                </ul>
              </div>
              <div style="margin-top: 18px; padding-top: 12px; border-top: 1px solid rgba(60, 30, 140, 0.1); font-size: 0.74rem; color: #3c1e8c; font-weight: 600;">
                <img src="icons/shared/gift.webp" alt="" class="pm-icon-img" /> 測試版免費無限制使用
              </div>
            </div>
            ...
            <div style="background: rgba(88, 86, 214, 0.04); border: 1.5px solid rgba(88, 86, 214, 0.2); border-radius: 16px; padding: 22px 18px; display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                  <span style="font-size: 1.4rem;"><img src="icons/header/pipeline-matrix.webp" alt="" class="pm-icon-img" /></span>
                  <h3 style="font-size: 1.05rem; font-weight: 700; color: var(--pm-text-primary); margin: 0;">專業製版與工藝</h3>
                </div>
                <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 0.82rem; color: var(--pm-text-secondary);">
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>專家級管線開關自訂</strong>：自由調控</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>雙面合版製版關聯</strong>：名片/明信片</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>造型刀模 + 0.2mm 內縮白墨</strong>：防溢白</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>A4/A3 智慧拼模試算</strong>：依模數而定，最高可省逾 8 成</span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>3D 燙金與局部光物理渲染</strong></span></li>
                </ul>
              </div>
            ...
            <div style="background: rgba(52, 199, 89, 0.04); border: 1.5px solid rgba(52, 199, 89, 0.2); border-radius: 16px; padding: 22px 18px; display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                  <img src="icons/shared/factory.webp" alt="" class="pm-icon-img" />
                  <h3 style="font-size: 1.05rem; font-weight: 700; color: var(--pm-text-primary); margin: 0;">出機規範與立印</h3>
                </div>
                <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 0.82rem; color: var(--pm-text-secondary);">
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>工業印前 PDF 出機檔（含出血/裁切線）</strong></span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>國際 ICC 描述檔 (Japan Color / FOGRA)</strong></span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>7-11 ibon / 全家超商列印檔案產生器</strong></span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>專業 ISO 印刷規範與送印規格表</strong></span></li>
                  <li style="display: flex; gap: 8px;"><img src="icons/shared/check.webp" alt="" class="pm-icon-img" /><span><strong>100% 離線免連網極速模式</strong></span></li>
                </ul>
              </div>
