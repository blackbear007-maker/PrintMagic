...
export class XiaoxiangAssistant {
  ...
  public static readonly LINES = {
    ...
    compareOn: '開啟【雙向滑桿對比】。左邊是原圖、右邊是 8x 超解析補齊 300 DPI 後的細節，一拉就知道差在哪。',
    imposition: '開啟【智慧拼模工具】。把多模排進一張 A4/A3 大紙，合版印刷現省 70% 費用。',
    dieline: '開啟【貼紙刀模與白墨產生器】。透明貼紙如果沒打白墨會透光，我已經幫你做好 0.2mm 內縮白墨與洋紅刀模線。',
    vectorOverlay: '開啟【K100 純黑文字層】。小字如果混了 CMY 會糊邊，用 K100 純黑輸出字字清晰見骨。',
    mockup: '開啟【展覽與情境 Mockup】。套進美術館畫框和北歐書桌，宣傳照直接拿去發 IG 或小紅書。',
