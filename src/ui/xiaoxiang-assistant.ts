...
export class XiaoxiangAssistant {
  ...
  public static readonly LINES = {
    welcome: '丟一張圖進來吧。直接拖進畫面、手機拍照，或點下面選海報、明信片或貼紙，我都幫你算好 3mm 出血了。',
    ...
    cloudEngine: '自建服務引擎連線中，支援自建 OCR / 向量化 / 低光提亮服務。',
    ...
    sticker: '【模切貼紙】模式。印透明貼紙的話已自動幫你附帶白墨防透光層，並留好 2mm 刀模線。',
    ...
    foilGold: '亮金燙金效果開了。晃一下螢幕能看反光，印實體的話白墨燙金層我也分好在 PDF 裡了。',
    ...
    imposition: '開啟【智慧拼模工具】。把多模排進一張 A4/A3 大紙，合版印刷現省 70% 費用。',
    ...
    convPrint: '超商專用圖準備好了。下樓去 7-11 或全家機台，點列印掃碼投幣就能印，不用在那邊手動調尺寸。',
