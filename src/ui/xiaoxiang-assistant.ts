...
export class XiaoxiangAssistant {
  ...
  public static readonly LINES = {
    ...
    advancedMode: '切到【進階模式】了。處理開關、色彩描述檔和進階工具都在上面，想調什麼自己開。',
    ...
    businessCard: '【商業名片】模式。四邊留了 3mm 安全框，重要文字放在框裡比較不會被裁到。',
    ...
    softProofOn: '開啟【CMYK 軟打樣】了。這是用公式估算的印刷顏色，暗部和飽和色會比螢幕暗一點；上傳印刷廠的 ICC 會更準。',
    softProofOff: '回到螢幕 RGB 鮮豔光色。',
    safeZoneOn: '開啟【出血線與安全框】。外圈是裁切出血保護，綠框以內重要文字保證切不到。',
    safeZoneOff: '關閉輔助框線，檢視純淨畫面。',
    loupeOn: '開啟【10x 網點放大鏡】。這是模擬的 CMYK 網點排列示意，實際網點由印刷廠的設備決定。',
    ...
    dieline: '開啟【貼紙刀模與白墨】。需要透明背景的圖；產出的是白墨層和刀模線的 PNG 參考檔，送印前請跟印刷廠確認他們要的刀模格式。',
  ...
  private sayRandomBanter(): void {
    const banters = [
      ...
      '「那就好。」',
      '「圖上的英文我會對一份常見拼錯表幫你看一下，但不是每個錯字都抓得到。」'
    ];
